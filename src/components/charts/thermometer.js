    ...
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" width={width} height={height} viewBox="0, 0, 150, 400">
            <defs>
                ...
                <clipPath id={"cut-off-red_" + rand}>
                    <rect x="38" y={currentValueY} width="600" height="500">
                    </rect>
                </clipPath>
                <clipPath id={"Clip_1" + rand}>
                ...
                <filter id={"Shadow_4" + rand}>
                    <feGaussianBlur in="SourceAlpha" stdDeviation="2.5" />
                    <feOffset dx="0" dy="2" result="offsetblur" />
                    <feFlood floodColor="#000000" />
                    <feComposite in2="offsetblur" operator="in" />
                </filter>
                <radialGradient id={"Gradient_1" + rand} gradientUnits="userSpaceOnUse" cx="75" cy="343.003" r="37.099">
                    <stop offset="0" stopColor="#e89266" />
                    <stop offset="1" stopColor="#d15e24" />
                </radialGradient>

                <filter id={"Shadow_6" + rand}>
                    <feGaussianBlur in="SourceAlpha" stdDeviation="2.5" />
                    <feOffset dx="0" dy="2" result="offsetblur" />
                    <feFlood floodColor="#000000" />
                    <feComposite in2="offsetblur" operator="in" />
            ...
            <g id={"Layer_1" + rand}>
                ...
                <g>
                    <path d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 L71,13.375 z" clipPath={"url(#Clip_3" + rand + ")"} filter={"url(#Shadow_4" + rand + ")"} fill="rgba(0,0,0,0.75)" />
                    <path clipPath={"url(#cut-off-red_"+ rand + ")"} d="M71,13.375 C78.559,13.506 89.07,19.681 90.588,27.125 L91,27.125 L91,316.532 C103.449,323.042 110.501,335.774 110.841,349.625 C110.841,370.06 94.794,386.625 75,386.625 C55.206,386.625 39.159,370.06 39.159,349.625 C39.135,335.555 46.893,323.321 59,316.532 L59,27.125 L59.412,27.125 C60.793,19.485 67.554,14.751 75,14.375 z" fill={"url(#Gradient_1" + rand + ")"} />
                </g>
                {showGoalline &&
                ...
                {allsteps.map(eachStep => {
                    return <g key={eachStep.val}>
                        ...
                        <path d={`M49.5, ${eachStep.y} L51, ${eachStep.y} `} filter={"url(#Shadow_10" + rand + ")"} fill="rgba(0,0,0,0.75)" />
